...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "CGMapSpec": (".cgmap", "CGMapSpec"),
    "expand_mapping_sites": (".cgmap", "expand_mapping_sites"),
    "load_cgmap_spec": (".cgmap", "load_cgmap_spec"),
    "load_mapping_yaml": (".cgmap", "load_mapping_yaml"),
    "bead_table_from_names": (".cgmap_builder", "bead_table_from_names"),
    "build_mapping": (".cgmap_builder", "build_mapping"),
    "parse_bead_table": (".cgmap_builder", "parse_bead_table"),
    "parse_gromacs_itp": (".cgmap_builder", "parse_gromacs_itp"),
    "write_mapping_yaml": (".cgmap_builder", "write_mapping_yaml"),
