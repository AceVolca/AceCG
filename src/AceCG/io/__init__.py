...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "LammpsTableSection": (".tables", "LammpsTableSection"),
    "parse_lammps_table": (".tables", "parse_lammps_table"),
    "read_lammps_table_section": (".tables", "read_lammps_table_section"),
    ...
    "FRAME_FIELDS": (".trajectory", "FRAME_FIELDS"),
    "FrameRecord": (".trajectory", "FrameRecord"),
    "MPITrajReader": (".trajectory", "MPITrajReader"),
    "TrajPlan": (".trajectory", "TrajPlan"),
    "format_for_path": (".trajectory", "format_for_path"),
    "install_offsets": (".trajectory", "install_offsets"),
    "iter_frames": (".trajectory", "iter_frames"),
    "map_ids_to_segments": (".trajectory", "map_ids_to_segments"),
    "open_universe": (".trajectory", "open_universe"),
    "partition_frame_ids": (".trajectory", "partition_frame_ids"),
    "reader_offsets": (".trajectory", "reader_offsets"),
    "select_frame_ids": (".trajectory", "select_frame_ids"),
    "xdr_readers": (".trajectory", "xdr_readers"),
