...
- 05/06/2026, Weizhi: Added potential-local mask/bounds metadata, versioned Forcefield metadata caching, hard-concrete L0 gate utilities, and a mask/bounds benchmark script.
